<x-layout title='Projeto'>
    ...
    <form method="POST" action="/projetos"> 
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="date" name="data_inicio" id="data_inicio" value="{{ old('data_inicio')}}" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                            @error('data_inicio')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href='/projetos' type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancelar</a>
