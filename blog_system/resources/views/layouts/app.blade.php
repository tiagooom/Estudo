        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="{{ route('articles.index') }}" class="nav-link px-2 {{ request()->is('articles*') ? 'text-secondary' : 'text-white' }}">Artigos</a></li>
                    <li><a href="" class="nav-link px-2 {{ request()->is('categories*') ? 'text-secondary' : 'text-white' }}">Categorias</a></li>
                </ul>
